    ...
    <section id="about" className="min-h-screen bg-[#0f0f0f] flex flex-col justify-center px-8 md:px-20 py-20">
      <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }} className="flex flex-col md:flex-row gap-16 items-center">
        <div className="flex-1">
          ...
          <h2 className="text-white text-4xl md:text-5xl font-bold mb-6 max-w-2xl">I'm a self-taught full-stack developer with a proven ability to ship real products.</h2>
          <p className="text-gray-400 text-lg max-w-2xl mb-8 leading-relaxed">From static business websites to full-stack web apps with auth, dashboards, and APIs — I build things that work. Based in Abuja, Nigeria, available for clients worldwide.</p>
          <div className="flex gap-8 mb-10 border-t border-b border-gray-800 py-6">
            {stats.map((stat) => (
              <div key={stat.label}>
